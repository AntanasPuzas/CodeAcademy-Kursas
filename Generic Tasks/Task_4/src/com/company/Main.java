...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ListOfNumbers result1 = Utilities.findWithMaxAverage(listObject1, listObject2, listObject3);
        ListOfNumbers result2 = Utilities.findWithMaxAverage(listObject1, listObject2);
